public static class Program
{
    static async Task Main()
    {
        ...
        //var KucoinAllTickDataSvc = serviceProvider.GetService<KucoinAllTickDataSvc>();

        // Use your service
        //await KucoinAllTickDataSvc.FetchAndSaveTickerData(token);
    ...
    // await KucoinAllTickDataSvc.ProcessData(tick, ct); });
